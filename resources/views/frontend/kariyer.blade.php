...
<!-- LOGO BEGIN -->
<div id="logo">
    <a href="{{ URL::to('/') }}" class="standard-logo" data-dark-logo="/frontend/images/logo-dark.png"><img src="{{ url($page->logo) }}" alt="Standart Logo"></a>
    ...
    <div class="content-wrap">
        ...
        <div class="container clearfix">
            ...
            <div class="col_two_fifth nobottommargin col_last">
                ...
                <form action="include/form-jobs.php" id="template-jobform" name="template-jobform" method="post" role="form">
