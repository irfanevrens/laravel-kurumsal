...
'files' => true)) !!}
{!! Form::hidden('galeri_id', $galeri_id) !!}
{!! Form::close() !!}
        <!-- BEGIN PHOTO -->
<div style="margin: 20px;">
    <span class="caption-subject font-red-sunglo bold">{{ $galeri->name }} Galerisi: </span><span class="caption-subject "> {{ $galeri->photos->count() }}</span>
</div>
...
<script src="/backend/assets/admin/pages/scripts/galeri-photo-sortable.js"></script>
@endsection
