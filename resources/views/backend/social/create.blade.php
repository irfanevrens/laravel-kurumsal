...
<div class="portlet light bg-inverse">
    <div class="portlet-title">
        <div class="caption">
            <span class="caption-subject font-red-sunglo bold uppercase">Sosyal Hesaplar</span>
        </div>
        <div class="tools">
    ...
    <div class="portlet-body form">
        <!-- BEGIN FORM-->
        {!! Form::open(['route' => ['admin.social.store'], 'method' => 'post']) !!}
        <div class="form-body">
            <!--/row-->
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row" style="padding-top: 4px">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label col-md-1">Simge</label>
                        <div class="col-md-11">
                            <select name="social_id" class="bs-select form-control">
