...
<head>
    ...
    <link href="/backend/assets/global/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css"/>
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="/backend/assets/admin/pages/css/login2.css" rel="stylesheet" type="text/css"/>
    <!-- END PAGE LEVEL SCRIPTS -->
    <!-- BEGIN THEME STYLES -->
    <link href="/backend/assets/global/css/components.css" id="style_components" rel="stylesheet" type="text/css"/>
    <link href="/backend/assets/global/css/plugins.css" rel="stylesheet" type="text/css"/>
    <link href="/backend/assets/admin/layout/css/layout.css" rel="stylesheet" type="text/css"/>
    <link href="/backend/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
    <link href="/backend/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
    <!-- END THEME STYLES -->
...
<div class="logo">
    <a href="index.html">
        <img src="/backend/assets/admin/layout/img/logo-big-white.png" style="height: 17px;" alt=""/>
    </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form class="login-form validate" action="login" method="POST">
        <div class="form-title">
            <span class="form-title">Hoşgeldin.</span>
            <span class="form-subtitle">Lütfen giriş yap.</span>
        </div>
        <div class="alert alert-danger display-hide">
            <button class="close" data-close="alert"></button>
            <span>Bir kullanıcı adı ve şifre gir.</span>
        </div>
        @if($errors->any())
        ...
        <div class="form-group">
            ...
            <label class="control-label visible-ie8 visible-ie9">Kullanıcı</label>
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix required" type="password" autocomplete="off" placeholder="Şifre" name="password"/>
        </div>
...
<div class="copyright hide">
    2015 © Umut Yerebakmaz. All Right Reserved.
</div>
<!-- END LOGIN -->
...
<script src="/backend/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
